...
export const HeroAiValueProposition = () => {
  ...
  const [authCounter, setauthCounter] = useState(false);

  return (
    <>
    {authCounter === true ? <Button variant="outline" className="z-9999 absolute top-4 right-4 w-20" onClick={()=>setauthCounter(false)}>Close</Button> : null}
    {authCounter === true ? <AuthButton param = {authCounter} /> : null}
      <section
      ...
      >
        ...
        >
          ...
          <button className="bg-white border border-neutral-100 text-neutral-500 px-4 py-2.5 rounded-full font-bold text-sm shadow-sm hover:text-black hover:border-neutral-300 transition-all cursor-pointer" onClick={()=>setauthCounter(true)}>
            Sign in
          </button>
        </TimelineAnimation>
        ...
        <div className="relative z-10 px-6">
          <article className="border-y w-full border-zinc-200">
            <div className="flex flex-col items-center text-center space-y-4 max-w-7xl mx-auto border-x border-zinc-200 p-8">
              ...
              >
                Access your products with <br className="hidden md:block" />{" "}
                accuraracy and accountability
              </TimelineAnimation>
              <TimelineAnimation
                once={true}
                as="p"
              ...
              >
                Turn rough ideas into clear, structured project briefs in
                seconds. Let AI handle the planning so you can focus on design,
